...
AlertToneAppletMaps::AlertToneAppletMaps()
{
	...
	m_map["/meegotouch/input_feedback/volume/priority2/volume/pulse"] = "qtn_sond_touch_screen";
	m_map["/meegotouch/input_feedback/volume/priority2/volume/vibra"] = "qtn_sond_touch_vibra";
