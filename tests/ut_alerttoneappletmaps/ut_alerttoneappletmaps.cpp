...
void Ut_AlertToneAppletMapsTests::alertToneAppletMapsContent_data()
{
      ...
      QTest::newRow("") << "/meegotouch/input_feedback/volume/priority2/volume/pulse" << "qtn_sond_touch_screen";
      QTest::newRow("") << "/meegotouch/input_feedback/volume/priority2/volume/vibra" << "qtn_sond_touch_vibra";
